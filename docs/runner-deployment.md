...
**Status:** implemented for the trusted `default` Guest Profile, including the foundational storage and identity phases. Workspace Bootstrap remains incomplete.
